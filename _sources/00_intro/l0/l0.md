...
The term that is most unknown in this expression is $f_l$, [as before](#f-i-and-f-c-the-fraction-of-biospheres-that-develop-intelligence-and-communication).  However, the final term has now become something that we might venture more of an opinion on than the mean communicative timescale, $L$.  
