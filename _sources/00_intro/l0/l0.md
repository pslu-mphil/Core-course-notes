...
Now we begin to leave the realm of the known.  The fundamental challenge with estimating the number of planets per star capable of hosting life, as with many of those remaining, is that it requires us to know something general about life as a phenomenon.  We are unable to agree on a definition of life (and even whether a definition is even useful, e.g., [Szostak, 2012](https://doi.org/10.1080/073911012010524998)).  

There are, however, two fronts on which we could make progress with this
...
The frequency of habitable planets that go on to develop life is a fascinating question, and really 
...
### $f_i$ and $f_c$, the fraction of life instantiates that develop 'intelligence' and communication
These two parameters take us now far beyond what even hypothetical outstanding discoveries in the solar system, such as evidence of ancient life on Mars, could tell us about. 
...
So, it is not that the type of question is wrong, just that the amount of information required to answer it in this form makes it intractable.  Just by removing a couple of terms from the expression, it becomes more relevant to a general search for life in the Universe -- we might settle in the first instance for the life we are searching for not being 'intelligent', giving
```{math}
:label: eq:drake2
...
Life on Earth suggests that once established, and provided the planetary climate remains within habitable bounds somewhere on its surface, life will survive refugia, radiating outwards when conditions allow.  
