...
---
The dominant outcome for debris interacting with a planet on a circular orbit is shown with different shading: it can be “accreted” onto the planet or “ejected” from the
 planetary system, both interactions could take longer than the age of the system (“remaining”), or the debris could be implanted in the “Oort Cloud”. The coloured dots 
show known exoplanets or Solar system planets.
```
...
figclass: margin-caption
---
What we know about the size distribution of material in a typical debris disk. The component from a few $\mu$m to a few cm can be constrained observationally, w\
hile that of larger bodies is an uncertain extrapolation.
```
...
```{figure} ../l12/figures/fig2.12.3a.png
---
name: fig:Fig.2.12.3
figclass: margin-caption
---
Infrared spectra of debris disks (left) and the modelling of the spectral features in one system to extract the dust composition showing this to have a signific\
ant component of silica (right).
```



```{figure} ../l12/figures/fig2.12.3b.png
---
name: fig:Fig.2.12.3b
figclass: margin-caption
---
**OLI - can you merge this with the above to make a two panel figure? Thanks! **Infrared spectra of debris disks (left) and the modelling of the spectral features in one system to extract the dust composition showing this to have a signific\
ant component of silica (right).
```
...
figclass: margin-caption
---
The exozodi luminosity function, i.e., the fraction of stars with fractional excesses at $12\mu$m ($F_{\rm disk}/F_\star$) above a given level. This has been ch\
aracterized photometrically for bright excesses with WISE (Kennedy & Wyatt 2013), and for fainter excesses by LBTI (Ertel et al. 2018).
...
Fig.\@ref(fig:Fig.2.12.4) shows the exozodi luminosity function, which can be interpreted as the fraction of stars with dust levels in the habitable zone above a given level. This shows how
 photometric studies with WISE found bright excesses towards 1:104 stars. These are found predominantly around stars in the 10-100Myr age range, exactly when giant impacts are
