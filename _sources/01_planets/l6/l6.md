...
An Interesting feature of the streaming instability is that it bypasses growth of objects at the 100 m -- 1 km scale, directly producing ~100 km sized **{term}`planetesimals`** (see [Simon+2016](https://doi.org/10.3847/0004-637X/822/1/55)).  This jumps over progressive growth and moves us directly into a new accretionary regime.  
