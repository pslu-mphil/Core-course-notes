...
![image info](./figures/creep.gif)

*Fig 1. A schematic representation of diffusion creep within crystals
...
![image info](./figures/sea_level.png)

*Fig 2. Past sea level curves from locations 
...
+ \int_{\partial U } \bm{\sigma} \hat{\mathbf{n}}  \dd S + 
...
![image info](./figures/rayleigh.png)

*Fig 3. Convection patterns of a fluid heated from below at Rayleigh number $10^{3}$ , $10^{6}$ , $10^{7}$ , $10^{8}$. The colour
...
![image info](./figures/geoid.png)

*Fig 4. Variations in the gravitational potential at the Earth's 
...
![image info](./figures/dynamic_topography.png)

*Fig 5. Observations of dynamic topography for transect
