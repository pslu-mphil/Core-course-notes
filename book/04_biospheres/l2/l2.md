...
- The photo reduction of CO<sub>2</sub> using an aqueous solution of bicarbonate and sulfite under UV irradiation. Converting CO<sub>2</sub> into various organic compounds (formate, hydroxymethanesulfonate, methanol, glycolate, acetate, tartronate, malonate, rac- and meso-tartrate, and hydrogen gas)({numref}`fig:03_CO2_reduction`).
